...
| **R33**     | **Uso de microdatos Documentar el diseño de la interfaz**         |
| --------------: | :------------------- |
...
| **R57**     | **Calcular media de sustrato necesario**         |
| --------------: | :------------------- |
...
| **R61**     | **Programar revisiones de los niveles de NH3/4, NO2 y NO3**         |
| --------------: | :------------------- |
...
| **R65**     | **Mostrar los peces que habitan en un acuario**         |
| --------------: | :------------------- |
...
| **R69**     | **Advertir al usuario en caso de falta de espacio vital para un pez**         |
| --------------: | :------------------- |
...
| **R73**     | **Programar revisiones de los niveles de pH, GH y KH en el agua**         |
| --------------: | :------------------- |
...
| **R77**     | **Advertir al usuario de incompatibilidades entre los peces del acuario.**         |
| --------------: | :------------------- |
...
| **R81**     | **Exportar datos del acuario**         |
| --------------: | :------------------- |
...
| **R85**     | **Introducir plantas en el acuario**         |
| --------------: | :------------------- |
...
| :------------ | :-----------: | :------: | :-------------: | :---------: | :------------: |
| (**R1**) Requisitos como incidencias | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [1](https://github.com/edumarrom/pdaw21/issues/1) |
| (**R2**) Código fuente | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [2](https://github.com/edumarrom/pdaw21/issues/2) |
| (**R3**) Estilo del código | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [3](https://github.com/edumarrom/pdaw21/issues/3) |
| (**R4**) Tres lanzamientos | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [4](https://github.com/edumarrom/pdaw21/issues/4) |
| (**R5**) README.md | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [5](https://github.com/edumarrom/pdaw21/issues/5) |
| (**R6**) Documentación | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [6](https://github.com/edumarrom/pdaw21/issues/6) |
| (**R7**) Incidencias en GitHub | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [7](https://github.com/edumarrom/pdaw21/issues/7) |
| (**R8**) Etiquetas e hitos | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [8](https://github.com/edumarrom/pdaw21/issues/8) |
| (**R9**) Rama master | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [9](https://github.com/edumarrom/pdaw21/issues/9) |
| (**R10**) Gestión del proyecto | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [10](https://github.com/edumarrom/pdaw21/issues/10) |
| (**R11**) Final de cada iteración | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [11](https://github.com/edumarrom/pdaw21/issues/11) |
| (**R12**) Validación de formularios | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [12](https://github.com/edumarrom/pdaw21/issues/12) |
| (**R13**) Gestión de ventanas | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [13](https://github.com/edumarrom/pdaw21/issues/13) |
| (**R14**) Manejo de eventos | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [14](https://github.com/edumarrom/pdaw21/issues/14) |
| (**R15**) DOM | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [15](https://github.com/edumarrom/pdaw21/issues/15) |
| (**R16**) Almacenamiento en el lado del cliente | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [16](https://github.com/edumarrom/pdaw21/issues/16) |
| (**R17**) jQuery, jQuery UI | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [17](https://github.com/edumarrom/pdaw21/issues/17) |
| (**R18**) Plugin no trabajado en clase | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [18](https://github.com/edumarrom/pdaw21/issues/18) |
| (**R19**) Utilización de AJAX | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [19](https://github.com/edumarrom/pdaw21/issues/19) |
| (**R20**) ECMAScript2015 (ES6) | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [20](https://github.com/edumarrom/pdaw21/issues/20) |
| (**R21**) PHP | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [21](https://github.com/edumarrom/pdaw21/issues/21) |
| (**R22**) Yii2 Laravel Framework | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [22](https://github.com/edumarrom/pdaw21/issues/22) |
| (**R23**) PostgreSQL | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [23](https://github.com/edumarrom/pdaw21/issues/23) |
| (**R24**) Heroku | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [24](https://github.com/edumarrom/pdaw21/issues/24) |
| (**R25**) Codeception | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [25](https://github.com/edumarrom/pdaw21/issues/25) |
| (**R26**) Code Climate | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [26](https://github.com/edumarrom/pdaw21/issues/26) |
| (**R27**) Aplicación escalable | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [27](https://github.com/edumarrom/pdaw21/issues/27) |
| (**R28**) Tecnología AJAX | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [28](https://github.com/edumarrom/pdaw21/issues/28) |
| (**R29**) Etiquetas semánticas de HTML5 | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [29](https://github.com/edumarrom/pdaw21/issues/29) |
| (**R30**) Presentación mediante CSS | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [30](https://github.com/edumarrom/pdaw21/issues/30) |
| (**R31**) Diseño flexible | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [31](https://github.com/edumarrom/pdaw21/issues/31) |
| (**R32**) Transiciones, transformaciones, animaciones y contenido multimedia | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [32](https://github.com/edumarrom/pdaw21/issues/32) |
| (**R33**) Uso de microdatos Documentar el diseño de la interfaz | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [33](https://github.com/edumarrom/pdaw21/issues/33) |
| (**R34**) Validación HTML5, CSS3 y accesibilidad | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [34](https://github.com/edumarrom/pdaw21/issues/34) |
| (**R35**) Diseño para varias resoluciones | Mínimo | Técnico | Fácil | v1 | | **Incidencia**  | [35](https://github.com/edumarrom/pdaw21/issues/35) |
...
| (**R72**) Advertir al usuario de los niveles de pH, GH y KH en el agua | Importante | Funcional | Fácil | v2 | | **Incidencia**  | [72](https://github.com/edumarrom/pdaw21/issues/72) |
